...
import { IError, IAlumno, IInputChangeHandler3, ISelectOption } from '../../types';
...
export default ({object, error, name, options, onChange}: { object: any, error: IError, name: any, options: IRadioOption[], onChange: IInputChangeHandler3 }) => {

  const handleOnChange = value => {
    // console.log('Value:', +value);
    onChange('carrera', value);
  };

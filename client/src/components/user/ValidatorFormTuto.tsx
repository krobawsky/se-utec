    ...
    submitForm(user.isNew ? 'POST' : 'PUT', url, user, (status, response) => {
      if (status === 200 || status === 201) {
        ...
        this.context.router.push({
          pathname: '/welcomeadmin/' + numero + '/users/list'
        });
      } else {
      ...
      <form className='form-horizontal'>
       <div className='row center-align'>
        <div className='col s12 m4 offset-m4'>
          <div className='card #00bfa5 teal accent-4 hoverable'>
            <div className='card-content white-text'>
              <span className='card-title'>Login Administrador</span>
              <div className='divider'></div>
                <div className='row'>
                  <form className='col s11' method='POST' action={url('/api/login')}>
                    <div className='row'>
                      <div className='input-field col s12'>
                          <img src='/images/adm.png' width='240' id='img' height='270' /><br/> <br/>

      ...
      <li><a className='subheader'>Opciones</a></li>
        ...
        <div className='col s11 container'>
            <div className='row'>
              ...
              <br/><br/>
                <a className='btn-floating btn-large waves-effect waves-light green tooltipped' data-position='top' data-delay='50' data-tooltip='Nuevo grupo' href={`/grupos/nuevo`}>
